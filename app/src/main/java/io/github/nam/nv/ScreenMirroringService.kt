...
import io.github.nam.nv.data.StreamingType
import io.github.nam.nv.media.StreamingInterface
import io.github.nam.nv.tool.IpAddressTool
import io.github.nam.nv.tool.QrCodeGeneratorTool
import io.github.nam.nv.websocket.WSStreaming
            ...
            mirroringSettingDataFlow.collect { mirroringSettingData ->
                ...
                if (isScreenMirroring.value) {
                    withContext(Dispatchers.Main) {
                        Toast.makeText(this@ScreenMirroringService,
                            R.string.zeromirror_service_stop_because_setting_update, Toast.LENGTH_SHORT).show()
                    }
                }
