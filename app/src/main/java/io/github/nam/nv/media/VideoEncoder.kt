...
import io.github.nam.nv.media.opengl.InputSurface
import io.github.nam.nv.media.opengl.TextureRenderer
...
class VideoEncoder {
    ...
    companion object {
        ...
        private val openGlRelatedDispatcher = newFixedThreadPoolContext(3,"ZeroMirrorOpenGlRelatedDispatcher")
